...
audit = '''(() => {
 ...
 const selectors = '.author-info,.home-name,.home-title,.home-pronunciation,.home-bio,.job-market-box,.news-item,.publication-paper,.service-item,.tile,.experiment-row,.site-footer-note';
